...
test_dir("C:/Eliot/SpaDES/modules/importLandWeb_BAP_Layers/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("C:/Eliot/SpaDES/modules/importLandWeb_BAP_Layers/tests/testthat/test-template.R")
