...
#    `functionName` is a function's name in your module (e.g., `preyEvent1`).
# 2. Copy this file to the tests folder (i.e., `C:/Users/Ceres Barros/test/prey/tests/testthat`).
...
test_that("test Event1 and Event2.", {
  ...
  if (exists("preyEvent1", envir = .GlobalEnv)) {
    simOutput <- preyEvent1(mySim)
  } else {
  ...
  if (exists("preyEvent2", envir = .GlobalEnv)) {
    simOutput <- preyEvent2(mySim)
  } else {
