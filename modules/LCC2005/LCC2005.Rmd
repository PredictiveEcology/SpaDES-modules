...
if (!file.exists(file.path(inputDir, "LandCoverOfCanada2005_V1_4", "LCC2005_V1_4a.tif"))) {
  ...
  download.file(url = url,
                destfile = file.path(inputDir, "LandCoverOfCanada2005_V1_4.zip"))
  unzip(zipfile = file.path(inputDir, "LandCoverOfCanada2005_V1_4.zip"),
        exdir = file.path(inputDir, "LandCoverOfCanada2005_V1_4"))
}
...
# load data
age <- raster::raster(file.path(inputDir, "age", "age.tif"))
lcc05 <- raster::raster(file.path(inputDir, "LandCoverOfCanada2005_V1_4", "LCC2005_V1_4a.tif"))
lcc05CRS <- crs(lcc05)
