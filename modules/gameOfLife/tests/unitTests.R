...
test_dir("/home/achubaty/Documents/GitHub/McIntire-lab/modules/gameOfLife/tests/testthat")

# Alternative, you can use test_file to test individual test file, e.g.:
test_file("/home/achubaty/Documents/GitHub/McIntire-lab/modules/gameOfLife/tests/testthat/test-template.R")
